...
new class extends Component {
    ...
    public function mount(): void
    {
        ...
        $svg = $writer->writeString($this->referralLink);
                    ...
                    <div x-show="showQr"
                        ...
                        <div x-transition:enter="transition ease-out duration-300"
                            ...
                            <div class="flex items-center justify-between px-5 pt-4 pb-3 sm:pt-5 border-b border-gray-100 dark:border-gray-700">
                                <div>
                                    <h3 class="text-sm font-bold text-gray-900 dark:text-white">Portal Invite QR Code</h3>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Scan to open the registration page</p>
                                </div>
                            ...
                            <div class="flex flex-col items-center px-6 py-5 gap-3">
                                ...
                                <p class="text-xs font-mono text-gray-400 dark:text-gray-500 text-center break-all leading-relaxed px-1">{{ $referralLink }}</p>
                                @if($riscoinId)
                                    <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300 text-xs font-semibold">
                            ...
                            <div class="px-5 pb-6 sm:pb-5">
                                <button @click="copy(); showQr = false"
                                        type="button"
                                        class="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold transition-colors active:scale-95">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                                    </svg>
                                    Copy Link
