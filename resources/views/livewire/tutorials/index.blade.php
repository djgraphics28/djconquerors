        ...
        <div>
            <div>
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <flux:button wire:click="create" variant="primary" data-test="new-tutorial-button">
                        Create Tutorial
                    </flux:button>
                </div>
                ...
                @if (session()->has('message'))
                    <div
                        class="mb-4 p-4 bg-green-100 border border-green-400 text-green-700 rounded dark:bg-green-900 dark:border-green-700 dark:text-green-300">
                        {{ session('message') }}
                    </div>
                @endif
                ...
                <!-- Search -->
                <div class="mb-6">
                    <flux:input wire:model.live="search" :label="__('Search Tutorials')" type="text"
                        :placeholder="__('Search by title...')" data-test="search-tutorials-input" />
                </div>
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition duration-150 ease-in-out">
                                    ...
                                    <td class="px-6 py-4 text-gray-500 dark:text-gray-400">
                                        <div class="text-sm max-w-md truncate">
                                            {{ $tutorial->description ?? 'No description' }}</div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex space-x-2">
                                            <flux:button wire:click="edit({{ $tutorial->id }})" variant="ghost"
                                                size="sm" data-test="edit-tutorial-{{ $tutorial->id }}">
                                                Edit
                                            </flux:button>
                                            <flux:button wire:click="togglePublish({{ $tutorial->id }})"
                                            ...
                                            <flux:button wire:click="delete({{ $tutorial->id }})" variant="ghost"
                                                size="sm"
                        ...
                        <div x-show="open"
                            ...
                            <div class="h-full flex flex-col bg-white dark:bg-gray-800 shadow-xl">
                                ...
                                <div class="flex-1 overflow-y-auto">
                                    <div class="px-6 py-4">
                                        <form wire:submit.prevent="{{ $tutorialId ? 'update' : 'store' }}"
                                            class="space-y-6">
                                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                                ...
                                                <div class="space-y-6">
                                                    ...
                                                    <!-- Video URL -->
                                                    <flux:input wire:model="video_url" :label="__('Video URL')"
                                                        type="url" required
                                                        :placeholder="__('Enter YouTube or Vimeo URL')"
                                                        data-test="video-url-input" />

                                                    <!-- Thumbnail URL -->
                                                    <flux:input wire:model="thumbnail_url" :label="__('Thumbnail URL')"
                                                        type="url" :placeholder="__('Enter thumbnail image URL')"
                                                ...
                                                <div class="space-y-6">
                                                            ...
                                                            @else
                                                                <div
                                                                    ...
                                                                    <div class="text-center">
                                                                        <svg class="mx-auto h-12 w-12 mb-3"
                                                                        ...
                                                                        <p class="text-sm">Enter a YouTube or Vimeo URL
                                                                            to see preview</p>
                                                                    </div>
                                                                </div>
                                                            @endif
                                                    ...
                                                    @if ($thumbnail_url)
                                                        <div>
                                                            <label
                                                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Thumbnail
                                                                Preview</label>
                                                            <div
                                                                class="border border-gray-200 dark:border-gray-600 rounded-lg p-2">
