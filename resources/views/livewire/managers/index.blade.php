                ...
                <div class="kanban-column bg-gray-50 dark:bg-gray-800 rounded-lg p-3 border border-gray-200 dark:border-gray-700"
                    ...
                    <div class="space-y-2 min-h-[120px] kanban-dropzone"
                        ...
                        @forelse ($managers as $manager)
                            ...
                            @if ($user)
                            <div class="kanban-card bg-white dark:bg-gray-700 rounded-lg shadow-sm p-3 flex items-center gap-3 cursor-move hover:shadow-md transition-all duration-200"
                                 draggable="true"
